...
const playlist = 'PL2_aWCzGMAwI9HK8YPVBjElbLbI3ufctn'
const result = 50;
          ...
          <div className='video_container'>
            
            {
              this.state.resultyt.map((link, i) => {
                console.log(link);
                var frame = <div className='ind_video'><iframe key={i}  title="TimeComplexity" src={link} frameBorder="0" allowFullScreen></iframe></div>
                return frame;
              })
            } 
          </div>
